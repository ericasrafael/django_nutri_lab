...
def logar(request):
    if request.method == "GET":
        ...
        # retorna true ou false para verificação se usuário existe ou não no banco de dados
...
def ativar_conta(request, token):
    # seleciona objeto na tabela Ativacao do BD, cujo token=token, se não existir, retorna erro 404
