...
# tabelas criadas pelo Django para BD 
# python manage.py makemigrations --> Django cria arquivo de migração dos dados no repositório migrations
# python manage.py migrate --> Efetua imigração para BD
...
class Pacientes(models.Model):
    ...
    nutri = models.ForeignKey(User, on_delete=models.CASCADE) # se o nutricionista for excluído do BD, seus pacientes também vão "cascade"
# SET_NULL apagaria apenas o nutricionista
